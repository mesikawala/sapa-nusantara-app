        ...
        <CarouselContent>
          {featuredGames.map((game) => (
            <CarouselItem key={game.id}>
              <div className="relative h-[180px] md:h-[240px] rounded-xl overflow-hidden cursor-pointer">
                <img 
                  src={game.image_url} 
                  alt={game.title}
                ...
                <div className="absolute inset-0 flex flex-col justify-center p-4 md:p-8">
                  <Badge className="w-fit mb-2 bg-accent text-accent-foreground text-xs md:text-sm px-3 py-1">
                    DISKON SPESIAL 20%
                  </Badge>
